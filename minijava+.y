...
%left OPERATOR PONTO LP RP LB RB OPERATORL
%right EXCLAMACAO
%debug
%%
...
MethodDecl: 	
			PUBLIC Type ID LP{push_scope(); } FormalList RP LC  VarDeclAux StatementAux RETORNA Exp PONTOEVIRGULA RC {pop_scope(); $$ = mk_methDecl_node($2,$3,$6,$9,$10,$12);incM();}
		;
...
Exp:		
			...
			|Exp OPERATORL Exp {$$=mk_expOperatorL_node($1,$2,$3);}
